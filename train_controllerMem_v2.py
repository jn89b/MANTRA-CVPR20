import argparse
from trainer.trainer_controllerMem_v2 import TrainerInterface
...
def parse_config():
    ...
    parser.add_argument("--model_ae", default='autoencoder_60steps_checkpoint/best-ae-epoch=11-val_eucl_mean=1.2070.ckpt')
